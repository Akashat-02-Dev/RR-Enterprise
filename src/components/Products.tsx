...
// 2. Categories Data
// 2. Updated categories with working Unsplash images
// 2. Updated categories with working Unsplash images
const categories: Category[] = [
  ...
  { title: "Compostable & Biodegradable", desc: "Earth-safe packaging solutions.", img: "https://images.unsplash.com/photo-1589365278144-c9e705f843ba?auto=format&fit=crop&q=80&w=800" }, // FIXED IMAGE LINK
...
<div className="relative w-full h-full">
            <Image 
              ...
              fill
              // Added sizes to tell Next.js the logo is small (improves performance)
...
<div className="aspect-[4/3] overflow-hidden rounded-[1.5rem] relative bg-eco-100">
                  ...
                  <Image 
                    ...
                    className="object-cover transform group-hover:scale-110 transition-transform duration-700 pointer-events-none" 
                  />
                </div>
